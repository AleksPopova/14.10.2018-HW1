...
3. Прибавить 5
4. Умножить на 2
Напишите программу, находящую самую короткую программу, 
получающую из числа X число Y. Программа должна выписать 
программу как последовательность команд. Можно считать, 
что такая программа существует. Если коротких программ
